...
import com.hi.R;
import com.hi.activity.MainActivity;
import com.hi.activity.ScanActivity;
import com.hi.activity.SearchUserActivity;
import com.hi.activity.TeamCheatCreateActvitiy;
import com.hi.adapter.TabViewPagerAdapter;
import com.hi.broadcast.AuthBroadcastReceiver;
import com.hi.broadcast.UpdateTeamListEvent;
import com.hi.factory.PopupWindowFactory;
...
import com.hi.nimsdk.custom.CustomAttachParser;
...
public class ChatFragment extends BaseFragment {
    ...
    private void showMenu() {
        ...
        menuView.findViewById(R.id.itemAddFriend).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(getActivity(), SearchUserActivity.class), MainActivity
                        .REQ_CLEAR_UNREAD);
                mPopupWindow.dismiss();
            }
        });
